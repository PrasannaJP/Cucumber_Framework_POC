package com.webuiframework.oua.uitests.autoit;
...
public class UAutoItX {
    ...
    public int ControlClick(String Title, String Text, String Button) {
        return lib().AU3_ControlClick(Title, Text, Button);
    }
    ...
    public int WinWaitActive(String Title) {
        return lib().AU3_WinWaitActive(new WString(Title));
    }
    
    public int WinWait(String Title) {
        return lib().AU3_WinWait(new WString(Title));
    }
    ...
    private static UAutoItXLib lib() {
    	if (instance == null) {
            String dllpath;
            dllpath = new File("src/test/resources/ThirdpartyTools/AutoItX3_x64.dll").getAbsolutePath().toString();
